<div>
    ...
    <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
            <h1 class="text-4xl font-semibold mb-2">Subscriptions</h1>
        </div>
    </div>
    ...
    <div x-show="$wire.model" class="fixed inset-0 flex items-center justify-end bg-gray-800 bg-opacity-50"
        style="display: none;">
        <div class="w-65 h-full max-w-xs md:max-w-none bg-white p-6 rounded-r-lg shadow-lg" style="width: 320px;">
            <!-- Modal Content -->
            ...
            <form wire:submit.prevent="storeCity" class="w-full mt-10">
                ...
                @error('description')
                    <span class="error">{{ $message }}</span>
                @enderror
                <input type="text" wire:model="price" placeholder="Price" class="mt-4 p-2 w-full border rounded">
            ...
            if (deleteButton) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire(
                            'Deleted!',
                            'The Subscriptions has been deleted.',
                            'success'
                        );
                    }
                });
